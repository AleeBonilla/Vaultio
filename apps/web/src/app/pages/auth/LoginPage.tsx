...
function GoogleIcon() {
  return (
    <svg aria-hidden="true" width="18" height="18" viewBox="0 0 18 18">
      ...
      <path
        fill="#34A853"
        d="M9 18c2.43 0 4.467-.806 5.956-2.18l-2.908-2.258c-.806.54-1.836.86-3.048.86-2.344 0-4.328-1.584-5.036-3.711H.957v2.332A8.997 8.997 0 0 0 9 18z"
      />
      <path
        fill="#FBBC05"
        ...
        <div className="rounded-2xl border border-blue-100 bg-white/85 p-8 shadow-2xl shadow-blue-900/10 backdrop-blur">
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              variant="primary"
              className="w-full rounded-full bg-blue-600 shadow-lg shadow-blue-600/15 hover:bg-blue-700"
