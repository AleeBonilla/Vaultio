...
export function ResourceCard({
  ...
  return (
    <Link to={`/app/resources/${id}`}>
      <div className="bg-white border border-[#E0E0E0] rounded-lg p-5 hover:border-[#0066CC] transition-all cursor-pointer h-full flex flex-col">
        <div className="flex items-start justify-between gap-3 mb-4">
          ...
          <button className="p-1.5 hover:bg-[#F5F7FA] rounded-md transition-colors flex-shrink-0 ml-auto">
            <Bookmark className="w-4 h-4 text-[#666666] hover:text-[#0066CC] transition-colors" />
          </button>
        </div>

        <h3 className="font-semibold text-[#1a1a1a] mb-2 line-clamp-2 min-h-[2.5rem]">{title}</h3>
