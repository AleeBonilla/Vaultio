  ...
  return (
    <div className="w-full">
      ...
      <input
        ...
        className={`w-full px-4 py-2.5 border border-[#E0E0E0] rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0066CC] focus-visible:border-[#0066CC] transition-colors bg-white ${
          error ? 'border-[#d32f2f]' : ''
        } ${className}`}
        {...props}
      />
